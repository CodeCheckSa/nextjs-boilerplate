...
1. حلل ما تراه بوضوح. للقياسات الرقمية: اذكر القيمة فقط إذا كُتبت صراحة على المخطط أو يمكن قياسها بدقة من مقياس الرسم المرفق. **يجب** توليد findings كيفية مفصلة عن العناصر المرئية (التصنيف الإشغالي، عدد الطوابق، الفراغات الإلزامية، الجدران المشتركة، نوع التخطيط، الواجهات، المخارج) حتى لو القياسات الدقيقة غير متاحة. عند غياب قياس، اذكر القيد في limitations دون اختراع رقم.
...
5. قدم تقييماً متوازناً ومحايداً. **لمخطط سكني متعدد الطوابق أو الوحدات، توقع توليد ست ملاحظات على الأقل** بناءً على ما تراه: التصنيف (R-3 / R-2)، الفراغات الإلزامية لكل وحدة (مجلس، نوم، مطبخ، حمام)، عدد الطوابق، الجدران المشتركة، المخارج، السلالم، الإضاءة والتهوية، نسب البناء إن قابلت قياسها من المقياس. مزج بين pass و fail و warn حسب ما يستحق. لا تترك findings فارغة إذا كان المخطط يحوي عناصر معمارية قابلة للتقييم.
